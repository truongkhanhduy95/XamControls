...
namespace XamControls.Droid.Controls
{
    public class TickerColumn
    {
        ...
        private void setCharacterIndices()
        {
            ...
            {
                TickerCharacterList.CharacterIndices indices =
        ...
        public void setAnimationProgress(float animationProgress)
        {
            ...
            // to the baseline).
            float currentBase = animationProgress * totalHeight;
            ...
            float additionalDelta = previousBottomDelta * (1f - animationProgress);
